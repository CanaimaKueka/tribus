...
class build_py(base_build_py):
    ...
    def finalize_options(self):
        ...
        self.package_data = get_package_data(
            path=BASEDIR, packages=self.packages,
            data_files=data, exclude_files=exclude_sources +
            exclude_patterns,
...
class install_data(base_install_data):
    ...
    def finalize_options(self):
        ...
        self.data_files = get_data_files(
            path=BASEDIR, patterns=include_data_patterns,
            exclude_files=exclude_sources + exclude_patterns)
