...
Tribus está siendo desarrollado en Python, utilizando el framework de desarrollo web Django. Como podrás ver estamos utiliizando GitHub para gestionar las colaboraciones, así que para empezar, haz un fork de este repositorio y clonalo en tu pc o clona el repositorio principal::
...
Existe un diagrama del diseño de la aplicación en tribus/data/docs/mindmap.svg (si prefieres ver un archivo png, está docs/mindmap.png pero debes hacer ``make build_html`` primero). El diagrama puede servirte como guía de referencia para ver todos los componentes de la plataforma, pero no lo utilices para empezar a desarrollar.
