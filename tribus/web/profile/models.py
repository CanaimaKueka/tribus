...
from django.db.models import OneToOneField, ManyToManyField, Model, CharField, IntegerField, ForeignKey, BooleanField
...
User.add_to_class('emailVisible',BooleanField(default = False))
